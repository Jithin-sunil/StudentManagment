...
<body>
 <table width="200" border="1">
    ...
    <?php
	$i=0;
	   $selQry="select * from tbl_leave e inner join tbl_student s on e.student_id=s.student_id inner join tbl_class c on c.class_id = s.class_id  where c.teacher_id='".$_SESSION['tid']."' ";
