...
if(isset($_POST["btn_submit"]))
{
	...
	$department=$_POST["txt_department"];
		...
		$insQry="insert into tbl_department(department_name)value('".$department."')";
		if($Con->query($insQry))
		{
		?>
		<script>
...
<body><form action="" method="post">
  <table width="200" border="1">
    <tr>
      ...
      <input type="text" name="txt_department" id="txt_department" /></td>
    </tr>
    <tr>
  ...
  <tr>
    ...
    <td><a href="department.php?did=<?php echo $row["department_id"]?>">
    delete</a>
